...
- Add a new entry to `C:\Users\Admin\OneDrive\Desktop\DEV Work\cocktail-analysis\Documentation\SESSION_HISTORY.md` with today's date and session details
...
- If there are more than 10 entries after adding yours, move the oldest entry to `C:\Users\Admin\OneDrive\Desktop\DEV Work\cocktail-analysis\Documentation\archives\session-history-archive.md`
- When archiving, place the entry below the "Last archived" date line and update that date

### 2. Update Project Status

- Refresh `C:\Users\Admin\OneDrive\Desktop\DEV Work\cocktail-analysis\Documentation\PROJECT_STATUS.md` with current implementation status
...
- Modify `C:\Users\Admin\OneDrive\Desktop\DEV Work\cocktail-analysis\Documentation\ACTIVE_TASKS.md`
...
- If any significant technical decisions were made, add them to `C:\Users\Admin\OneDrive\Desktop\DEV Work\cocktail-analysis\Documentation\DEV_NOTES.md`
...
- Update `C:\Users\Admin\OneDrive\Desktop\DEV Work\cocktail-analysis\README.md` if setup instructions changed
- Update `C:\Users\Admin\OneDrive\Desktop\DEV Work\cocktail-analysis\CHANGELOG.md` with version changes
...
### `C:\Users\Admin\OneDrive\Desktop\DEV Work\cocktail-analysis\Documentation\SESSION_HISTORY.md`
...
### `C:\Users\Admin\OneDrive\Desktop\DEV Work\cocktail-analysis\Documentation\PROJECT_STATUS.md`
...
### `C:\Users\Admin\OneDrive\Desktop\DEV Work\cocktail-analysis\Documentation\ACTIVE_TASKS.md`
...
### `C:\Users\Admin\OneDrive\Desktop\DEV Work\cocktail-analysis\Documentation\DEV_NOTES.md`
...
### `C:\Users\Admin\OneDrive\Desktop\DEV Work\cocktail-analysis\Documentation\archives\session-history-archive.md`
...
1. **Paths**: Always use full absolute paths starting with `C:\Users\Admin\OneDrive\Desktop\DEV Work\cocktail-analysis\`
...
7. **SQLite Notes**: Document any `npm rebuild sqlite3` or `npm rebuild better-sqlite3` requirements or database migration issues
...
- Database migrations
- Query optimization
- sqlite3 configuration (async callback-based)
...
**Create or update**: `C:\Users\Admin\OneDrive\Desktop\DEV Work\cocktail-analysis\Documentation\metrics\prompt-effectiveness.md`

**If metrics directory doesn't exist**: Create `C:\Users\Admin\OneDrive\Desktop\DEV Work\cocktail-analysis\Documentation\metrics\` first
...
- **SQLite Issues**: Any sqlite3 or better-sqlite3 rebuild requirements or database issues
...
- [ ] `npm rebuild sqlite3` ran successfully (or `npm rebuild better-sqlite3` if migrated)
